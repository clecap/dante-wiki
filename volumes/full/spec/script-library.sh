...
# append configuration lines to /root/.msmtprc inside of the docker container
function appendMSMTPRC () {
  printf "*** appendMSMTPRC: generating /root/.msmtprc ..."
  local APPEND_TEXT ='### file generated by script-library.sh of DanteWiki
...
'
  ...
  docker exec ${LAP_CONTAINER} /bin/ash -c "echo '$APPEND_TEXT' > /root/.msmtprc"
  docker exec ${LAP_CONTAINER} /bin/ash -c "chmod 600 /root/.msmtprc"
